...
static float grabber_goal_position[GrabberMotorLocation::GRABBER_MOTOR_NUM_MAX] = {507.0, 507.0};
static float grabber_goal_position_from_topic[GrabberMotorLocation::GRABBER_MOTOR_NUM_MAX] = {507.0, 507.0};
