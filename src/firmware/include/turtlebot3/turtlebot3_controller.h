...
class Turtlebot3Controller
{
 public:
  ...
  bool init(float max_lin_x_vel, float max_lin_y_vel, float max_ang_vel, uint8_t scale_lin_vel = 1, uint8_t scale_ang_vel = 1);
 ...
 private:
  ...
  float max_lin_x_vel_;
  float min_lin_x_vel_;
  float max_lin_y_vel_;
  float min_lin_y_vel_;
  float max_ang_vel_;
  float min_ang_vel_;
